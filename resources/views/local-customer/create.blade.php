    ...
    <div class="col-12 grid-margin createtable">
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">New Local Customer</h4>
            </div>
          ...
          <form class="form-sample" action="{{ route('localcustomer.store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="customer_code" value="{{$invoice_no}}" readonly  />
                  </div>
                </div>
              </div>
              <div class="col-md-12">
