...
<div class="container">
  <h3>Pending Edit Requests (Receipt voucher)</h3>
  ...
  @endforeach
    ...
    <form action="{{ route('receiptvoucher.approveEditRequest', $voucher->id) }}" method="POST" style="display:inline-block;">
      @csrf
      <button type="submit" class="btn btn-success btn-sm">Approve</button>
    </form>

    <form action="{{ route('receiptvoucher.rejectEditRequest', $voucher->id) }}" method="POST" style="display:inline-block;">
      @csrf
