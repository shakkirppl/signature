        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6 text-right">
              <a href="{{ route('customer-complaint.create') }}" class="newicon"><i class="mdi mdi-new-box"></i></a>
            </div>
          </div>
            ...
            <table class="table table-bordered table-striped table-sm" style="font-size: 12px;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ Str::limit($record->complaint_details, 30) }}</td>
                  <td>{{ Str::limit($record->investigation_findings, 30) }}</td>
                  <td>{{ Str::limit($record->corrective_action, 30) }}</td>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Manager Signature</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <div class="modal-body text-center">
                              <img src="{{ asset('storage/signatures/' . $record->manager_signature) }}" alt="Signature" style="width: 100%; max-width: 800px; height: auto;">
                            </div>
                          </div>
                        </div>
                      </div>
