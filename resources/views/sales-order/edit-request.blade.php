        ...
        <div class="col-12 grid-margin createtable">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('sales-order.submit-edit-request', $order->id) }}" method="POST">
                        @csrf
                      
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label for="code" class="form-label">Order No:</label>
                                <input type="text" class="form-control" id="code" name="order_no" value="{{ $order->order_no }}" readonly>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-3">
                                ...
                                <input type="number" id="total" name="grand_total" class="form-control" value="{{ $order->grand_total }}" readonly step="any">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-3">
                                <label for="advance_amount" class="form-label">Advance:</label>
                                <input type="number" id="advance_amount" name="advance_amount" class="form-control" value="{{ $order->advance_amount }}" step="any">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-3">
                                <label for="balance_amount" class="form-label">Balance:</label>
                                <input type="number" id="balance_amount" name="balance_amount" class="form-control" value="{{ $order->balance_amount }}" readonly step="any">
                            </div>
                        </div>
