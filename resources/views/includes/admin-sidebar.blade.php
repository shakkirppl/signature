...
<li class="nav-item">
            ...
            <div class="collapse" id="accounts">
              ...
              <li class="nav-item"> <a class="nav-link" href="{{URL::to('/return-supplier-index')}}">Supplier Final Payment </a></li>   
...
<li class="nav-item">
            ...
            <div class="collapse" id="quality-department">
              ...
              <li class="nav-item"> <a class="nav-link" href="{{URL::to('temperature-monitoring-index')}}">Temperature Monitoring</a></li>  
               ...
               <li class="nav-item"> <a class="nav-link" href="{{URL::to('calibration-record-index')}}">Calibration Record</a></li> 
              </ul>
            </div>
          </li> 
...
<li class="nav-item">
      ...
      <li class="nav-item">
            ...
            <div class="collapse" id="production">
              ...
              @if($user->designation_id == 1 || $user->designation_id == 5)

              <li class="nav-item"> <a class="nav-link" href="{{URL::to('weight-approval/facility')}}">Facility  Approval</a></li> 
               @endif
               @if($user->designation_id == 1 ||  $user->designation_id == 3)

              <li class="nav-item"> <a class="nav-link" href="{{URL::to('weight-approval/accountant')}}">Accountant  Approval</a></li> 
  @endif
              @endif
