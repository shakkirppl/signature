                        ...
                        <table class="table table-bordered" id="productTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="products[{{ $key }}][qty]" class="form-control qty" value="{{ $detail->qty }}" step="0.01" required style="width: 150px;"></td>
                                    <td><input type="text" name="products[{{ $key }}][rate]" class="form-control rate" value="{{ $detail->rate }}"  step="0.01" style="width: 150px;"></td>
                                    <td><input type="text" name="products[{{ $key }}][total]" class="form-control total" value="{{ $detail->qty * $detail->rate }}" readonly style="width: 150px;"></td>
